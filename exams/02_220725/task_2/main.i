...
# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/include/stddef.h" 1 3 4
# 329 "/usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/include/stddef.h" 3 4
typedef int wchar_t;
...
int comp_whole_digit_acucmulator(const void *, const void *);
int digit_sum(int);
int comp_abs(const void *, const void *);
# 5 "main.c" 2
...
# 39 "main.c"
        ...
        qsort(num_arr, 10, sizeof(num_arr[0]), comparators[comp_option]);
